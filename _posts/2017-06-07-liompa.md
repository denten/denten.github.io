...
[^1]: Silk was (and still is in the hobbyist community) commonly used to create an aerodynamic surface around airplane wings or ailerons. See for example "[How to Silk a Model Aircraft Wing][6]" on *Airfield Models*: <https://web.archive.org/web/20170614043457/http://www.airfieldmodels.com/information_source/how_to_articles_for_model_builders/finishing_techniques/silk_a_wing/index.htm>
